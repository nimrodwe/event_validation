...
class BaseClass:
    def __init__(self, localhost, logger=None):
        ...
        self.synthetic_dataset = DataLoader.load_synthetic_event()
        self.validation_dataset = DataLoader.load_validation_row()
        self.expected_types = DataLoader.load_expected_types()
